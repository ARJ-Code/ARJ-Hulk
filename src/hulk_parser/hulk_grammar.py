...
hulk_grammar.add_attributed_production('I', ['I1','F'], [])

hulk_grammar.add_attributed_production('Is1', ['I1 Is1','I1'], [])
hulk_grammar.add_attributed_production('I1',['E ;'],[])
hulk_grammar.add_attributed_production('E',['Eb','El','Eif','Ef','Ew'],[])
...
hulk_grammar.add_attributed_production('Gb',['True','False','Ea','Cb'],[])
hulk_grammar.add_attributed_production('Cb',['Ea < Ea','Ea > Ea','Ea <= Ea','Ea >= Ea','Ea == Ea','Ea != Ea'],[])
...
hulk_grammar.add_attributed_production('Oa',['num','Es'],[])

hulk_grammar.add_attributed_production('Es',['Es @ Ts','Es @@ Ts','Ts'],[])
hulk_grammar.add_attributed_production('Ts',['string','W'],[])

hulk_grammar.add_attributed_production('A',['id := E'],[])

hulk_grammar.add_attributed_production('W',['( E )','IDc','Ec'],[])
...
hulk_grammar.add_attributed_production('IDc',['id . IDc','id'],[])

hulk_grammar.add_attributed_production('Ec',['IDc ( P1 )'],[])
hulk_grammar.add_attributed_production('P1',['P2',''],[])
hulk_grammar.add_attributed_production('P2',['E , D2','E'],[])

hulk_grammar.add_attributed_production('F',['function id ( C1 ) T C2'],[])
hulk_grammar.add_attributed_production('C2',['=> E ;','B'],[])
hulk_grammar.add_attributed_production('C1',['C3',''],[])
hulk_grammar.add_attributed_production('C3',['id T , C3','id T'],[])
